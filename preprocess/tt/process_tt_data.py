...
def preload_all_data():
    ...
    # 2. Log
    print("\n[2/3] 加载 Log 数据...")
    log_dir = os.path.join(_project_root, 'data', 'processed_data', 'tt', 'log')
...
if __name__ == "__main__":
    ...
    # 2. Stats
    stats_file = os.path.join(_project_root, "data", "processed_data", "tt", "tt_norm_stats.pkl")
    ...
    # 4. Save
    out_path = os.path.join(_project_root, "data", "processed_data", "tt", "dataset.pkl")
